...
COPY intelligence/pyproject.docker.toml /app/pyproject.toml
COPY intelligence/poetry.lock* /app/

# Copy library dependencies
COPY runtime-lib /app/runtime-lib
...
CMD ["python3", "src/main.py"]#FROM tensorflow/tensorflow:2.15.0-gpu
FROM paperspace/gradient-base:pt211-tf215-cudatk120-py311-20240202
